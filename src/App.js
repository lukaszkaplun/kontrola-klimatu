...
class App extends Component {
  ...
  showSubpage = number => {
    if (this.state.subpage === number) {
      ...
      if ((this.state.isSmallScreen || this.state.isMobile)) {
  ...
  componentDidUpdate(prevProps, prevState) {
    if ((prevState.isSmallScreen || prevState.isMobile) !==(this.state.isSmallScreen || this.state.isMobile)) {
  ...
  render() {
    return (
      <div className="app-wrapper">
        ...
        {this.state.enableFloatingIcon && (this.state.isSmallScreen || this.state.isMobile) && (
