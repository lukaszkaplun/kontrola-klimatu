            ...
            <Row noGutters className="slide-2">
              <Col xs={12} md={6}>
                ...
                <p className="paragraph">
                  ...
                  kuchnia). Instalacja rekuperacji pozwala na prawidłową wymianę
                  powietrza w budynku przez cały rok. Zjawisko odzysku ciepła
                  pozwala na odzyskanie energii cieplnej z zużytego powietrza, a
                  co za tym idzie umożliwia znaczne obniżenie kosztów
                  eksploatacyjnych.
                </p>
              </Col>
              <Col xs={12} md={6} className="align-self-center">
                ...
                <ul>
                  ...
                  <li>zużyte powietrze z zanieczyszczniami bytowymi</li>
                  <li>
                    zanieczyszczone powietrze, z którego odzyskano energię
                  </li>
                </ul>
              </Col>
            </Row>
