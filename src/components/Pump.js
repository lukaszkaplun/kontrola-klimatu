        ...
        <Swiper {...params}>
          <Row noGutters className="slide-1">
            ...
            <h2 className="heading">Pompy ciepła</h2>
              ...
              <ul>
                <li>
                  <span>Przyjazne </span> środowisku ogrzewanie bez oleju, gazu
                  czy węgla
                </li>
                <li>
                  <span>Bezobsługowość</span> systemu grzewczego - Pompa ciepła
                  pracuje całkowicie automatycznie. Nie wymaga zewnętrznej
                  ingerencji w postaci uzupełniania paliwa. Nie trzeba się
                  troszczyć o termin wizyty kominiarza czy serwisanta kotła
                </li>
                <li>
                  <span>Oszczędność</span> miejsca – nie trzeba wydzielać
                  pomieszczenia kotłowni, moduł wewnętrzny pompy ciepła może być
                  umieszczony np. w kuchni
                </li>
                <li>
                ...
                <li>
                  <span>Nie</span> wytwarza płomieni co za tym idzie nie stanowi
            ...
            <h2 className="heading">Pompy ciepła</h2>
              ...
              <ul>
                <li>
                  ...
                  <strong>(6)</strong> oraz zawór rozpręży <strong>(5)</strong>.
                  Natomiast w jednostce wewnętrznej <strong>(2)</strong>{" "}
            ...
            <Col xs={12} md={6}>
              ...
              <ul>
                <li>
                  ...
                  - Wszystkie elementy układu chłodniczego takie jak: sprężarka{" "}
                  <strong>(2)</strong>, parownik <strong>(3)</strong>, zawór
                  rozprężny <strong>(4)</strong>, zawór 4-drogowy{" "}
                  <strong>(5)</strong> i skraplacz <strong>(6)</strong>{" "}
                  umieszczone są w jednostce zewnętrznej <strong>(1)</strong>.
                  Urządzenie z instalacją grzewczą połączone jest w sposób
                  hydrauliczny gdzie czynnikiem roboczym jest roztwór glikolowy.
                </li>
              </ul>
            </Col>
            <Col xs={12} md={6} >
            ...
            <Col xs={12} md={6}>
              ...
              <ul>
                <li>
                  ...
                  temperaturowych. Producenci pomp ciepła typu powietrze/woda są
                  zobowiązani aby dla swoich produktów podawać wartość COP dla
                  parametrów A7W35 i A2W35. Oznacza to, że podawane COP dotyczy
                  temperatury powietrza zewnętrznego <strong>(A)</strong> na
                  poziomie 7 lub 2 stopni Celsjusza, a temperatura wody w
                  instalacji grzewczej <strong>(W)</strong> 35 stopni Celsjusza.
                </li>
              </ul>
              <p className="paragraph">
                <strong>Przykład:</strong> Gdy producent podaje, że współczynnik
                COP dla danego urządzenia wynosi 5 oznacza to, że dla budynku w
                którym zapotrzebowanie na ciepło wynosi około 10 kW, 8 kW
                pokryte jest z tzw. Energii odnawialnej. a 2 kW z energii
                elektrycznej.
              </p>
            </Col>
            <Col xs={12} md={6} >
          ...
          <Row noGutters className="slide-6">
            <Col xs={12} md={6}>
              ...
              <p className="paragraph">
                ...
                najbardziej ekonomicznym rozwiązaniem z eksploatacyjnego punktu
                widzenia.
              </p>
            </Col>
            <Col xs={12} md={6} >
